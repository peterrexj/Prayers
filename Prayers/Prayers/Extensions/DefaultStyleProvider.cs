            ...
            switch (appTheme)
            {
                ...
                case AppThemes.Light:
                    return new StyleModelDefault
                    {
                        ...
                        HighlightBgSource = CssGradientSource.Parse("linear-gradient(135deg, rgba(19,176,223,0.259999990463257) 0%, rgba(19,176,223,0.259999990463257) 23%, rgba(16,160,197,0.259999990463257) 23%, rgba(16,160,197,0.259999990463257) 65%, rgba(13,144,172,0.259999990463257) 65%, rgba(13,144,172,0.259999990463257) 70%, rgba(9,129,146,0.259999990463257) 70%, rgba(9,129,146,0.259999990463257) 74%, rgba(6,113,121,0.259999990463257) 74%, rgba(6,113,121,0.259999990463257) 90%, rgba(3,97,95,0.259999990463257) 90%, rgba(3,97,95,0.259999990463257) 100%),linear-gradient(45deg, rgba(65,234,230,0.259999990463257) 0%, rgba(65,234,230,0.259999990463257) 28%, rgba(88,192,215,0.259999990463257) 28%, rgba(88,192,215,0.259999990463257) 55%, rgba(110,150,201,0.259999990463257) 55%, rgba(110,150,201,0.259999990463257) 66%, rgba(133,107,186,0.259999990463257) 66%, rgba(133,107,186,0.259999990463257) 80%),linear-gradient(90deg, rgba(27,194,246,1) 0%, rgba(27,194,246,1) 24.17609%, rgba(39,174,237,1) 39.94703%)"),
